        ...
        for (let house of houses) {
            $('#app').prepend(
                ...
                <div class="card-body">
                    ...
                    <div class="row>
                        <div class="col-sm">
                            <input type="text" id="${house._id}-room-name" class="form-control" placeholder="Model Name">
                        </div>
                        <div class="col-sm">
                            <input type="text" id="${house._id}-room-area" class="form-control" placeholder="Year">
                        </div>
                    </div>
            ...
            for (let room of house.rooms) {
                $(`#${house._id}`).find('.card-body').append(
                    ...
                    <button class="btn btn-danger" onclick="DOMManager.deleteRoom('${house._id}', '${room._id}')">Delete</button>`
                );
